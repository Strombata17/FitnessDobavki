...
namespace Dobavki.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(ApplicationDbContext context, UserManager<User> usr)
        {
            _context = context;
            _userManager = usr;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ProductId,Quantity,DateRegister")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
