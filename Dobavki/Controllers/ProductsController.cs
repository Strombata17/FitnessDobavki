...
namespace Dobavki.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TypeProductId,CategoriesId,Quantity,URLimage,Apply,Price,Description,DateRegister")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TypeProductId,CategoriesId,Quantity,URLimage,Apply,Price,Description,DateRegister")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
